...
/**
 * PipelineSimulationApi Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
...
class PipelineSimulationApi
{
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['simulatePipeline'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function simulatePipeline(string $contentType = self::contentTypes['simulatePipeline'][0])
    {
        $this->simulatePipelineWithHttpInfo($contentType);
    }

    /**
     * Operation simulatePipelineWithHttpInfo
     *
     * Simulate sending pipeline
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['simulatePipeline'] to see the possible values for this operation
     ...
     */
    public function simulatePipelineWithHttpInfo(string $contentType = self::contentTypes['simulatePipeline'][0])
    {
        $request = $this->simulatePipelineRequest($contentType);
    ...
    /**
     * Operation simulatePipelineAsync
     *
     * Simulate sending pipeline
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['simulatePipeline'] to see the possible values for this operation
     ...
     */
    public function simulatePipelineAsync(string $contentType = self::contentTypes['simulatePipeline'][0])
    {
        return $this->simulatePipelineAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation simulatePipelineAsyncWithHttpInfo
     *
     * Simulate sending pipeline
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['simulatePipeline'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function simulatePipelineAsyncWithHttpInfo(string $contentType = self::contentTypes['simulatePipeline'][0])
    {
        $returnType = '';
        $request = $this->simulatePipelineRequest($contentType);
    ...
    /**
     * Create request for operation 'simulatePipeline'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['simulatePipeline'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function simulatePipelineRequest(string $contentType = self::contentTypes['simulatePipeline'][0])
    {


        $resourcePath = '/v1/simulate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
