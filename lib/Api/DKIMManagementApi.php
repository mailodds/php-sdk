...
/**
 * DKIMManagementApi Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
...
class DKIMManagementApi
{
    ...
    /**
     * Operation getDkimDnsRecord
     *
     * Get DKIM DNS record
     *
     * @param  string $domain_id domain_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDkimDnsRecord'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function getDkimDnsRecord($domain_id, string $contentType = self::contentTypes['getDkimDnsRecord'][0])
    {
        $this->getDkimDnsRecordWithHttpInfo($domain_id, $contentType);
    }

    /**
     * Operation getDkimDnsRecordWithHttpInfo
     *
     * Get DKIM DNS record
     *
     ...
     */
    public function getDkimDnsRecordWithHttpInfo($domain_id, string $contentType = self::contentTypes['getDkimDnsRecord'][0])
    {
        $request = $this->getDkimDnsRecordRequest($domain_id, $contentType);
    ...
    /**
     * Operation getDkimDnsRecordAsync
     *
     * Get DKIM DNS record
     *
     * @param  string $domain_id (required)
     ...
     */
    public function getDkimDnsRecordAsync($domain_id, string $contentType = self::contentTypes['getDkimDnsRecord'][0])
    {
        return $this->getDkimDnsRecordAsyncWithHttpInfo($domain_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDkimDnsRecordAsyncWithHttpInfo
     *
     * Get DKIM DNS record
     *
     * @param  string $domain_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDkimDnsRecordAsyncWithHttpInfo($domain_id, string $contentType = self::contentTypes['getDkimDnsRecord'][0])
    {
        $returnType = '';
        $request = $this->getDkimDnsRecordRequest($domain_id, $contentType);
    ...
    /**
     * Create request for operation 'getDkimDnsRecord'
     *
     * @param  string $domain_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDkimDnsRecord'] to see the possible values for this operation
     *
     ...
     */
    public function getDkimDnsRecordRequest($domain_id, string $contentType = self::contentTypes['getDkimDnsRecord'][0])
    {

        // verify the required parameter 'domain_id' is set
        if ($domain_id === null || (is_array($domain_id) && count($domain_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_id when calling getDkimDnsRecord'
            );
        }


        $resourcePath = '/v1/sending-domains/{domain_id}/dkim/dns-record';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation rotateDkim
     *
     * Rotate DKIM keys
     *
     * @param  string $domain_id domain_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['rotateDkim'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function rotateDkim($domain_id, string $contentType = self::contentTypes['rotateDkim'][0])
    {
        $this->rotateDkimWithHttpInfo($domain_id, $contentType);
    }

    /**
     * Operation rotateDkimWithHttpInfo
     *
     * Rotate DKIM keys
     *
     * @param  string $domain_id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function rotateDkimWithHttpInfo($domain_id, string $contentType = self::contentTypes['rotateDkim'][0])
    {
        $request = $this->rotateDkimRequest($domain_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rotateDkimAsync($domain_id, string $contentType = self::contentTypes['rotateDkim'][0])
    {
        return $this->rotateDkimAsyncWithHttpInfo($domain_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation rotateDkimAsyncWithHttpInfo
     *
     * Rotate DKIM keys
     *
     * @param  string $domain_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rotateDkimAsyncWithHttpInfo($domain_id, string $contentType = self::contentTypes['rotateDkim'][0])
    {
        $returnType = '';
        $request = $this->rotateDkimRequest($domain_id, $contentType);
    ...
    /**
     * Create request for operation 'rotateDkim'
     *
     * @param  string $domain_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['rotateDkim'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function rotateDkimRequest($domain_id, string $contentType = self::contentTypes['rotateDkim'][0])
    {

        // verify the required parameter 'domain_id' is set
        if ($domain_id === null || (is_array($domain_id) && count($domain_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_id when calling rotateDkim'
            );
        }


        $resourcePath = '/v1/sending-domains/{domain_id}/dkim/rotate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
