...
class OAuth20Api
{
    ...
    /**
     * Operation oauthRegisterClient
     *
     * Register OAuth client
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['oauthRegisterClient'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MailOdds\Model\OAuthClientRegistration
     */
    public function oauthRegisterClient(string $contentType = self::contentTypes['oauthRegisterClient'][0])
    {
        list($response) = $this->oauthRegisterClientWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation oauthRegisterClientWithHttpInfo
     *
     * Register OAuth client
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['oauthRegisterClient'] to see the possible values for this operation
     ...
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MailOdds\Model\OAuthClientRegistration, HTTP status code, HTTP response headers (array of strings)
     */
    public function oauthRegisterClientWithHttpInfo(string $contentType = self::contentTypes['oauthRegisterClient'][0])
    {
        $request = $this->oauthRegisterClientRequest($contentType);
    ...
    /**
     * Operation oauthRegisterClientAsync
     *
     * Register OAuth client
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['oauthRegisterClient'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function oauthRegisterClientAsync(string $contentType = self::contentTypes['oauthRegisterClient'][0])
    {
        return $this->oauthRegisterClientAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation oauthRegisterClientAsyncWithHttpInfo
     *
     * Register OAuth client
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['oauthRegisterClient'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function oauthRegisterClientAsyncWithHttpInfo(string $contentType = self::contentTypes['oauthRegisterClient'][0])
    {
        $returnType = '\MailOdds\Model\OAuthClientRegistration';
        $request = $this->oauthRegisterClientRequest($contentType);
    ...
    /**
     * Create request for operation 'oauthRegisterClient'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['oauthRegisterClient'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function oauthRegisterClientRequest(string $contentType = self::contentTypes['oauthRegisterClient'][0])
    {
