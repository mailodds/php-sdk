...
/**
 * ContentClassificationApi Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
...
class ContentClassificationApi
{
    ...
    /**
     * Operation classifyContent
     *
     * Classify email content
     *
     * @param  \MailOdds\Model\ClassifyContentRequest $classify_content_request classify_content_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['classifyContent'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MailOdds\Model\ClassifyContent200Response|\MailOdds\Model\ErrorResponse|\MailOdds\Model\ErrorResponse
     */
    public function classifyContent($classify_content_request, string $contentType = self::contentTypes['classifyContent'][0])
    {
        list($response) = $this->classifyContentWithHttpInfo($classify_content_request, $contentType);
        return $response;
    }

    /**
     * Operation classifyContentWithHttpInfo
     *
     * Classify email content
     *
     * @param  \MailOdds\Model\ClassifyContentRequest $classify_content_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['classifyContent'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MailOdds\Model\ClassifyContent200Response|\MailOdds\Model\ErrorResponse|\MailOdds\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function classifyContentWithHttpInfo($classify_content_request, string $contentType = self::contentTypes['classifyContent'][0])
    {
        $request = $this->classifyContentRequest($classify_content_request, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\MailOdds\Model\ClassifyContent200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation classifyContentAsync
     *
     * Classify email content
     *
     * @param  \MailOdds\Model\ClassifyContentRequest $classify_content_request (required)
     ...
     */
    public function classifyContentAsync($classify_content_request, string $contentType = self::contentTypes['classifyContent'][0])
    {
        return $this->classifyContentAsyncWithHttpInfo($classify_content_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation classifyContentAsyncWithHttpInfo
     *
     * Classify email content
     *
     * @param  \MailOdds\Model\ClassifyContentRequest $classify_content_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function classifyContentAsyncWithHttpInfo($classify_content_request, string $contentType = self::contentTypes['classifyContent'][0])
    {
        $returnType = '\MailOdds\Model\ClassifyContent200Response';
        $request = $this->classifyContentRequest($classify_content_request, $contentType);
    ...
    /**
     * Create request for operation 'classifyContent'
     *
     * @param  \MailOdds\Model\ClassifyContentRequest $classify_content_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['classifyContent'] to see the possible values for this operation
     *
     ...
     */
    public function classifyContentRequest($classify_content_request, string $contentType = self::contentTypes['classifyContent'][0])
    {

        // verify the required parameter 'classify_content_request' is set
        if ($classify_content_request === null || (is_array($classify_content_request) && count($classify_content_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $classify_content_request when calling classifyContent'
            );
        }


        $resourcePath = '/v1/content-check';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($classify_content_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($classify_content_request));
            } else {
                $httpBody = $classify_content_request;
            }
