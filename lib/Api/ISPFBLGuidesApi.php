...
/**
 * ISPFBLGuidesApi Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
...
class ISPFBLGuidesApi
{
    ...
    /**
     * Operation getIspFblGuide
     *
     * Get ISP FBL guide
     *
     * @param  string $isp_id isp_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIspFblGuide'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function getIspFblGuide($isp_id, string $contentType = self::contentTypes['getIspFblGuide'][0])
    {
        $this->getIspFblGuideWithHttpInfo($isp_id, $contentType);
    }

    /**
     * Operation getIspFblGuideWithHttpInfo
     *
     * Get ISP FBL guide
     *
     * @param  string $isp_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIspFblGuide'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function getIspFblGuideWithHttpInfo($isp_id, string $contentType = self::contentTypes['getIspFblGuide'][0])
    {
        $request = $this->getIspFblGuideRequest($isp_id, $contentType);
     ...
     */
    public function getIspFblGuideAsync($isp_id, string $contentType = self::contentTypes['getIspFblGuide'][0])
    {
        return $this->getIspFblGuideAsyncWithHttpInfo($isp_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getIspFblGuideAsyncWithHttpInfo
     *
     * Get ISP FBL guide
     *
     * @param  string $isp_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIspFblGuideAsyncWithHttpInfo($isp_id, string $contentType = self::contentTypes['getIspFblGuide'][0])
    {
        $returnType = '';
        $request = $this->getIspFblGuideRequest($isp_id, $contentType);
    ...
    /**
     * Create request for operation 'getIspFblGuide'
     *
     * @param  string $isp_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIspFblGuide'] to see the possible values for this operation
     *
     ...
     */
    public function getIspFblGuideRequest($isp_id, string $contentType = self::contentTypes['getIspFblGuide'][0])
    {

        // verify the required parameter 'isp_id' is set
        if ($isp_id === null || (is_array($isp_id) && count($isp_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $isp_id when calling getIspFblGuide'
            );
        }


        $resourcePath = '/v1/isp-fbl/guides/{isp_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($isp_id !== null) {
            $resourcePath = str_replace(
                '{' . 'isp_id' . '}',
                ObjectSerializer::toPathValue($isp_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation listIspFblGuides
     *
     * List ISP FBL guides
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listIspFblGuides'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function listIspFblGuides(string $contentType = self::contentTypes['listIspFblGuides'][0])
    {
        $this->listIspFblGuidesWithHttpInfo($contentType);
    }

    /**
     * Operation listIspFblGuidesWithHttpInfo
     *
     * List ISP FBL guides
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listIspFblGuides'] to see the possible values for this operation
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function listIspFblGuidesWithHttpInfo(string $contentType = self::contentTypes['listIspFblGuides'][0])
    {
        $request = $this->listIspFblGuidesRequest($contentType);
    ...
    /**
     * Operation listIspFblGuidesAsync
     *
     * List ISP FBL guides
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listIspFblGuides'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIspFblGuidesAsync(string $contentType = self::contentTypes['listIspFblGuides'][0])
    {
        return $this->listIspFblGuidesAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listIspFblGuidesAsyncWithHttpInfo
     *
     * List ISP FBL guides
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listIspFblGuides'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIspFblGuidesAsyncWithHttpInfo(string $contentType = self::contentTypes['listIspFblGuides'][0])
    {
        $returnType = '';
        $request = $this->listIspFblGuidesRequest($contentType);
    ...
    /**
     * Create request for operation 'listIspFblGuides'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listIspFblGuides'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIspFblGuidesRequest(string $contentType = self::contentTypes['listIspFblGuides'][0])
    {


        $resourcePath = '/v1/isp-fbl/guides';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
