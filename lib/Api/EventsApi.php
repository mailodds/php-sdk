...
class EventsApi
{
     ...
     *
     * @param  \MailOdds\Model\TrackEventRequest $track_event_request track_event_request (required)
     ...
     * @return \MailOdds\Model\TrackEventResponse|\MailOdds\Model\TrackEventResponse|\MailOdds\Model\ErrorResponse|\MailOdds\Model\ErrorResponse
     */
    public function trackEvent($track_event_request, string $contentType = self::contentTypes['trackEvent'][0])
    {
        list($response) = $this->trackEventWithHttpInfo($track_event_request, $contentType);
        return $response;
    }
     ...
     * Track a commerce event
     *
     * @param  \MailOdds\Model\TrackEventRequest $track_event_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackEvent'] to see the possible values for this operation
     *
     * @throws \MailOdds\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MailOdds\Model\TrackEventResponse|\MailOdds\Model\TrackEventResponse|\MailOdds\Model\ErrorResponse|\MailOdds\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function trackEventWithHttpInfo($track_event_request, string $contentType = self::contentTypes['trackEvent'][0])
    {
        $request = $this->trackEventRequest($track_event_request, $contentType);
     ...
     */
    public function trackEventAsync($track_event_request, string $contentType = self::contentTypes['trackEvent'][0])
    {
        return $this->trackEventAsyncWithHttpInfo($track_event_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackEventAsyncWithHttpInfo($track_event_request, string $contentType = self::contentTypes['trackEvent'][0])
    {
        $returnType = '\MailOdds\Model\TrackEventResponse';
        $request = $this->trackEventRequest($track_event_request, $contentType);
     ...
     */
    public function trackEventRequest($track_event_request, string $contentType = self::contentTypes['trackEvent'][0])
    {
        ...
        if (isset($track_event_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($track_event_request));
            } else {
