...
class CreateVariantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateVariantRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Variant name (e.g., \"Variant A\")
     *
     * @return self
     */
     ...
     * Sets weight
     *
     * @param int $weight Traffic weight percentage (all variant weights must sum to 100)
     *
     * @return self
     */
    public function setWeight($weight)
    {
        ...
        if (($weight > 100)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling CreateVariantRequest., must be smaller than or equal to 100.');
        }
        if (($weight < 1)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling CreateVariantRequest., must be bigger than or equal to 1.');
        }
