...
/**
 * RunSpamCheckRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class RunSpamCheckRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'runSpamCheck_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('client_scores', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['from_domain'] === null) {
            $invalidProperties[] = "'from_domain' can't be null";
        }
     ...
     * Sets from_domain
     *
     * @param string $from_domain Sending domain to check
     *
     * @return self
     */
     ...
     * Sets links
     *
     * @param string[]|null $links URLs included in the email
     *
     * @return self
     */
     ...
     *
     * @param string|null $subject_preview Email subject line to analyze
     *
     * @return self
     */
     ...
     * @return object|null
     */
    public function getClientScores()
    {
        return $this->container['client_scores'];
    }

    /**
     * Sets client_scores
     *
     * @param object|null $client_scores Client-side spam scores to include in analysis
     *
     * @return self
     */
    public function setClientScores($client_scores)
    {
        if (is_null($client_scores)) {
            throw new \InvalidArgumentException('non-nullable client_scores cannot be null');
        }
        $this->container['client_scores'] = $client_scores;
