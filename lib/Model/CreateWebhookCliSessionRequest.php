...
/**
 * CreateWebhookCliSessionRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class CreateWebhookCliSessionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createWebhookCliSession_request';
    ...
    {
        $this->setIfExists('forward_url', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['forward_url'];
    }

    /**
     * Sets forward_url
     *
     * @param string|null $forward_url Local URL where webhooks will be forwarded
     *
     * @return self
     */
    public function setForwardUrl($forward_url)
    {
        if (is_null($forward_url)) {
            throw new \InvalidArgumentException('non-nullable forward_url cannot be null');
        }
        $this->container['forward_url'] = $forward_url;
