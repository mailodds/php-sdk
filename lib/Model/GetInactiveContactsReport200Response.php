...
/**
 * GetInactiveContactsReport200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class GetInactiveContactsReport200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getInactiveContactsReport_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'total_contacts' => 'int',
        'inactive_rate' => 'float',
        'by_list' => '\MailOdds\Model\GetInactiveContactsReport200ResponseByListInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'inactive_count' => 'setInactiveCount',
        'total_contacts' => 'setTotalContacts',
        'inactive_rate' => 'setInactiveRate',
        'by_list' => 'setByList'
    ];
    ...
    protected static $getters = [
        ...
        'inactive_count' => 'getInactiveCount',
        'total_contacts' => 'getTotalContacts',
        'inactive_rate' => 'getInactiveRate',
        'by_list' => 'getByList'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('inactive_count', $data ?? [], null);
        $this->setIfExists('total_contacts', $data ?? [], null);
        $this->setIfExists('inactive_rate', $data ?? [], null);
        $this->setIfExists('by_list', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['inactive_count'];
    }

    /**
     * Sets inactive_count
     *
     * @param int|null $inactive_count inactive_count
     *
     * @return self
     */
    public function setInactiveCount($inactive_count)
    {
        if (is_null($inactive_count)) {
            throw new \InvalidArgumentException('non-nullable inactive_count cannot be null');
        }
        $this->container['inactive_count'] = $inactive_count;
     ...
     * @return float|null
     */
    public function getInactiveRate()
    {
        return $this->container['inactive_rate'];
    }

    /**
     * Sets inactive_rate
     *
     * @param float|null $inactive_rate inactive_rate
     *
     * @return self
     */
    public function setInactiveRate($inactive_rate)
    {
        if (is_null($inactive_rate)) {
            throw new \InvalidArgumentException('non-nullable inactive_rate cannot be null');
        }
        $this->container['inactive_rate'] = $inactive_rate;
     ...
     * Gets by_list
     *
     * @return \MailOdds\Model\GetInactiveContactsReport200ResponseByListInner[]|null
     */
    public function getByList()
    {
        return $this->container['by_list'];
    }

    /**
     * Sets by_list
     *
     * @param \MailOdds\Model\GetInactiveContactsReport200ResponseByListInner[]|null $by_list by_list
     *
     * @return self
     */
    public function setByList($by_list)
    {
        if (is_null($by_list)) {
            throw new \InvalidArgumentException('non-nullable by_list cannot be null');
        }
        $this->container['by_list'] = $by_list;
