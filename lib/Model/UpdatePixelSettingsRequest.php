...
/**
 * UpdatePixelSettingsRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePixelSettingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updatePixelSettings_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pixel_subscribe_list_id'] === null && !$this->isNullableSetToNull('pixel_subscribe_list_id')) {
            $invalidProperties[] = "'pixel_subscribe_list_id' can't be null";
        }
     ...
     *
     * @param int|null $pixel_subscribe_list_id Contact list ID for pixel subscriptions, or null to disable
     *
     * @return self
     */
