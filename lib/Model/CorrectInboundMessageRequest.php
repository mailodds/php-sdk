...
/**
 * CorrectInboundMessageRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class CorrectInboundMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'correctInboundMessage_request';
    ...
    */
     ...
     * Sets correction
     *
     * @param string $correction Corrected classification label
     *
     * @return self
     */
