...
/**
 * GetDomainHookEffectiveness200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class GetDomainHookEffectiveness200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDomainHookEffectiveness_200_response';
    ...
    protected static $setters = [
        ...
        'effectiveness' => 'setEffectiveness'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('effectiveness', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['effectiveness'];
    }

    /**
     * Sets effectiveness
     *
     * @param object|null $effectiveness effectiveness
     *
     * @return self
     */
    public function setEffectiveness($effectiveness)
    {
        if (is_null($effectiveness)) {
            throw new \InvalidArgumentException('non-nullable effectiveness cannot be null');
        }
        $this->container['effectiveness'] = $effectiveness;
