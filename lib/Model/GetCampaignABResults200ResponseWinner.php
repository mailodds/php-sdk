...
/**
 * GetCampaignABResults200ResponseWinner Class Doc Comment
 *
 * @category Class
 * @description Winning variant, or null if no statistical winner yet
 * @package  MailOdds
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetCampaignABResults200ResponseWinner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCampaignABResults_200_response_winner';
    ...
    */
     ...
     * Sets metric
     *
     * @param string|null $metric Metric used to determine winner (open_rate or click_rate)
     *
     * @return self
     */
     ...
     * Sets confidence
     *
     * @param float|null $confidence Statistical confidence level (0-1)
     *
     * @return self
     */
