...
/**
 * McpCapabilitiesPillarsInnerToolsInner Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class McpCapabilitiesPillarsInnerToolsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'McpCapabilities_pillars_inner_tools_inner';
    ...
    */
     ...
     * Sets required_scope
     *
     * @param string|null $required_scope OAuth scope required to use this tool
     *
     * @return self
     */
    public function setRequiredScope($required_scope)
    {
        if (is_null($required_scope)) {
            array_push($this->openAPINullablesSetToNull, 'required_scope');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('required_scope', $nullablesSetToNull);
            if ($index !== FALSE) {
