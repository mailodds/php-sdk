...
/**
 * BlacklistMonitor Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class BlacklistMonitor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlacklistMonitor';
    ...
    protected static $openAPITypes = [
        ...
        'latest_check' => '\MailOdds\Model\BlacklistMonitorLatestCheck',
        'created_at' => '\DateTime'
    ];
    ...
    public const TARGET_TYPE_IP = 'ip';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('latest_check', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Monitor UUID
     *
     * @return self
     */
     ...
     * Sets target
     *
     * @param string|null $target IP address or domain being monitored
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Current status (clean, listed)
     *
     * @return self
     */
     ...
     * Sets listed_count
     *
     * @param int|null $listed_count Number of blacklists currently listing this target
     *
     * @return self
     */
     ...
     * Gets latest_check
     *
     * @return \MailOdds\Model\BlacklistMonitorLatestCheck|null
     */
    public function getLatestCheck()
    {
        return $this->container['latest_check'];
    }

    /**
     * Sets latest_check
     *
     * @param \MailOdds\Model\BlacklistMonitorLatestCheck|null $latest_check latest_check
     *
     * @return self
     */
    public function setLatestCheck($latest_check)
    {
        if (is_null($latest_check)) {
            array_push($this->openAPINullablesSetToNull, 'latest_check');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('latest_check', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['latest_check'] = $latest_check;
