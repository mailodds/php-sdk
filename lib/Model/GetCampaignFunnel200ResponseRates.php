...
/**
 * GetCampaignFunnel200ResponseRates Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class GetCampaignFunnel200ResponseRates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCampaignFunnel_200_response_rates';
    ...
    protected static $setters = [
        ...
        'click_to_open_rate' => 'setClickToOpenRate',
    ...
    protected static $getters = [
        ...
        'click_to_open_rate' => 'getClickToOpenRate',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('click_to_open_rate', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets click_to_open_rate
     *
     * @return float|null
     */
    public function getClickToOpenRate()
    {
        return $this->container['click_to_open_rate'];
    }

    /**
     * Sets click_to_open_rate
     *
     * @param float|null $click_to_open_rate click_to_open_rate
     *
     * @return self
     */
    public function setClickToOpenRate($click_to_open_rate)
    {
        if (is_null($click_to_open_rate)) {
            throw new \InvalidArgumentException('non-nullable click_to_open_rate cannot be null');
        }
        $this->container['click_to_open_rate'] = $click_to_open_rate;
     ...
     *
     * @param float|null $unsubscribe_rate unsubscribe_rate
     *
     * @return self
     */
