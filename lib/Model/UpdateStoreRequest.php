...
class UpdateStoreRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateStore_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sync_interval_seconds', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sync_interval_seconds']) && ($this->container['sync_interval_seconds'] < 1800)) {
            $invalidProperties[] = "invalid value for 'sync_interval_seconds', must be bigger than or equal to 1800.";
        }
     ...
     * Sets store_name
     *
     * @param string|null $store_name Display name for the store
     *
     * @return self
     */
     ...
     *
     * @param int|null $sync_interval_seconds Auto-sync interval in seconds (min 1800)
     *
     * @return self
     */
    public function setSyncIntervalSeconds($sync_interval_seconds)
    {
        ...
        if (($sync_interval_seconds < 1800)) {
            throw new \InvalidArgumentException('invalid value for $sync_interval_seconds when calling UpdateStoreRequest., must be bigger than or equal to 1800.');
        }
     ...
     * Sets credentials
     *
     * @param object|null $credentials Updated store credentials (connection is tested before saving)
     *
     * @return self
     */
