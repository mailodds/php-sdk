...
/**
 * CrossReferenceBounces200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class CrossReferenceBounces200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'crossReferenceBounces_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'request_id' => 'string',
        'cross_reference' => '\MailOdds\Model\CrossReferenceBounces200ResponseCrossReference'
    ];
    ...
    protected static $getters = [
        ...
        'cross_reference' => 'getCrossReference'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cross_reference', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets cross_reference
     *
     * @return \MailOdds\Model\CrossReferenceBounces200ResponseCrossReference|null
     */
    public function getCrossReference()
    {
        return $this->container['cross_reference'];
    }

    /**
     * Sets cross_reference
     *
     * @param \MailOdds\Model\CrossReferenceBounces200ResponseCrossReference|null $cross_reference cross_reference
     *
     * @return self
     */
    public function setCrossReference($cross_reference)
    {
        if (is_null($cross_reference)) {
            throw new \InvalidArgumentException('non-nullable cross_reference cannot be null');
        }
        $this->container['cross_reference'] = $cross_reference;
