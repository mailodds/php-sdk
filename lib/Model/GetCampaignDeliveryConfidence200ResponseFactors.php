...
/**
 * GetCampaignDeliveryConfidence200ResponseFactors Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class GetCampaignDeliveryConfidence200ResponseFactors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCampaignDeliveryConfidence_200_response_factors';
    ...
    protected static $openAPITypes = [
        'list_quality' => '\MailOdds\Model\GetCampaignDeliveryConfidence200ResponseFactorsListQuality',
        'sender_reputation' => '\MailOdds\Model\GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation',
        'domain_auth' => '\MailOdds\Model\GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth'
    ];
    ...
    protected static $setters = [
        'list_quality' => 'setListQuality',
        'sender_reputation' => 'setSenderReputation',
        'domain_auth' => 'setDomainAuth'
    ];
    ...
    protected static $getters = [
        'list_quality' => 'getListQuality',
        'sender_reputation' => 'getSenderReputation',
        'domain_auth' => 'getDomainAuth'
    ];
    ...
    {
        $this->setIfExists('list_quality', $data ?? [], null);
        $this->setIfExists('sender_reputation', $data ?? [], null);
        $this->setIfExists('domain_auth', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets list_quality
     *
     * @return \MailOdds\Model\GetCampaignDeliveryConfidence200ResponseFactorsListQuality|null
     */
    public function getListQuality()
    {
        return $this->container['list_quality'];
    }

    /**
     * Sets list_quality
     *
     * @param \MailOdds\Model\GetCampaignDeliveryConfidence200ResponseFactorsListQuality|null $list_quality list_quality
     *
     * @return self
     */
    public function setListQuality($list_quality)
    {
        if (is_null($list_quality)) {
            throw new \InvalidArgumentException('non-nullable list_quality cannot be null');
        }
        $this->container['list_quality'] = $list_quality;

        return $this;
    }

    /**
     * Gets sender_reputation
     *
     * @return \MailOdds\Model\GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation|null
     */
    public function getSenderReputation()
    {
        return $this->container['sender_reputation'];
    }

    /**
     * Sets sender_reputation
     *
     * @param \MailOdds\Model\GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation|null $sender_reputation sender_reputation
     *
     * @return self
     */
    public function setSenderReputation($sender_reputation)
    {
        if (is_null($sender_reputation)) {
            throw new \InvalidArgumentException('non-nullable sender_reputation cannot be null');
        }
        $this->container['sender_reputation'] = $sender_reputation;
     ...
     * Gets domain_auth
     *
     * @return \MailOdds\Model\GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth|null
     */
    public function getDomainAuth()
    {
        return $this->container['domain_auth'];
    }

    /**
     * Sets domain_auth
     *
     * @param \MailOdds\Model\GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth|null $domain_auth domain_auth
     *
     * @return self
     */
    public function setDomainAuth($domain_auth)
    {
        if (is_null($domain_auth)) {
            throw new \InvalidArgumentException('non-nullable domain_auth cannot be null');
        }
        $this->container['domain_auth'] = $domain_auth;
