...
/**
 * AppendToContactList200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class AppendToContactList200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'appendToContactList_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'request_id' => 'string',
        'contact_list' => '\MailOdds\Model\ContactList',
        'added_count' => 'int',
        'candidate_count' => 'int',
        'duplicate_count' => 'int',
        'breakdown' => 'object'
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('duplicate_count', $data ?? [], null);
    ...
    */
     ...
     * Gets contact_list
     *
     * @return \MailOdds\Model\ContactList|null
     */
     ...
     * Sets contact_list
     *
     * @param \MailOdds\Model\ContactList|null $contact_list contact_list
     *
     * @return self
     */
     ...
     * Sets added_count
     *
     * @param int|null $added_count Number of new emails added
     *
     * @return self
     */
     ...
     *
     * @param int|null $candidate_count Total candidates from jobs
     *
     * @return self
     */
    public function setCandidateCount($candidate_count)
    {
        if (is_null($candidate_count)) {
            throw new \InvalidArgumentException('non-nullable candidate_count cannot be null');
        }
     ...
     *
     * @param int|null $duplicate_count Duplicates skipped
     *
     * @return self
     */
     ...
     * Sets breakdown
     *
     * @param object|null $breakdown Per-status breakdown of candidates
     *
     * @return self
     */
