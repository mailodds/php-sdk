...
/**
 * SuppressDisengagedRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class SuppressDisengagedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'suppressDisengaged_request';
    ...
    protected static $setters = [
        'inactive_days' => 'setInactiveDays',
        'min_sends' => 'setMinSends',
        'dry_run' => 'setDryRun'
    ];
    ...
    protected static $getters = [
        'inactive_days' => 'getInactiveDays',
        'min_sends' => 'getMinSends',
        'dry_run' => 'getDryRun'
    ];
    ...
    {
        $this->setIfExists('inactive_days', $data ?? [], 180);
        $this->setIfExists('min_sends', $data ?? [], 10);
        $this->setIfExists('dry_run', $data ?? [], true);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['inactive_days']) && ($this->container['inactive_days'] > 365)) {
            $invalidProperties[] = "invalid value for 'inactive_days', must be smaller than or equal to 365.";
        }

        if (!is_null($this->container['inactive_days']) && ($this->container['inactive_days'] < 1)) {
            $invalidProperties[] = "invalid value for 'inactive_days', must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['min_sends']) && ($this->container['min_sends'] > 100)) {
            $invalidProperties[] = "invalid value for 'min_sends', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['min_sends']) && ($this->container['min_sends'] < 1)) {
            $invalidProperties[] = "invalid value for 'min_sends', must be bigger than or equal to 1.";
        }
    ...
    {
        return $this->container['inactive_days'];
    }

    /**
     * Sets inactive_days
     *
     * @param int|null $inactive_days Days of inactivity threshold
     *
     * @return self
     */
    public function setInactiveDays($inactive_days)
    {
        if (is_null($inactive_days)) {
            throw new \InvalidArgumentException('non-nullable inactive_days cannot be null');
        }

        if (($inactive_days > 365)) {
            throw new \InvalidArgumentException('invalid value for $inactive_days when calling SuppressDisengagedRequest., must be smaller than or equal to 365.');
        }
        if (($inactive_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $inactive_days when calling SuppressDisengagedRequest., must be bigger than or equal to 1.');
        }

        $this->container['inactive_days'] = $inactive_days;
     ...
     * @return int|null
     */
    public function getMinSends()
    {
        return $this->container['min_sends'];
    }

    /**
     * Sets min_sends
     *
     * @param int|null $min_sends Minimum sends to qualify
     *
     * @return self
     */
    public function setMinSends($min_sends)
    {
        if (is_null($min_sends)) {
            throw new \InvalidArgumentException('non-nullable min_sends cannot be null');
        }

        if (($min_sends > 100)) {
            throw new \InvalidArgumentException('invalid value for $min_sends when calling SuppressDisengagedRequest., must be smaller than or equal to 100.');
        }
        if (($min_sends < 1)) {
            throw new \InvalidArgumentException('invalid value for $min_sends when calling SuppressDisengagedRequest., must be bigger than or equal to 1.');
        }

        $this->container['min_sends'] = $min_sends;
     ...
     * Sets dry_run
     *
     * @param bool|null $dry_run Preview without suppressing
     *
     * @return self
     */
