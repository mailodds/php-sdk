...
/**
 * AddBlacklistMonitorRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class AddBlacklistMonitorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addBlacklistMonitor_request';
    ...
    */
     ...
     * Sets target
     *
     * @param string $target IP address or domain to monitor
     *
     * @return self
     */
     ...
     * Sets target_type
     *
     * @param string $target_type Whether the target is an IP or domain
     *
     * @return self
     */
