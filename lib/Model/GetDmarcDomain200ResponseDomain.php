...
/**
 * GetDmarcDomain200ResponseDomain Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class GetDmarcDomain200ResponseDomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDmarcDomain_200_response_domain';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'summary' => '\MailOdds\Model\GetDmarcDomain200ResponseDomainAllOfSummary'
    ];
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'domain' => null,
        'reporting_address' => null,
        'dns_verified' => null,
        'dns_verified_at' => 'date-time',
    ...
    protected static $setters = [
        'id' => 'setId',
        'domain' => 'setDomain',
        'reporting_address' => 'setReportingAddress',
        'dns_verified' => 'setDnsVerified',
        'dns_verified_at' => 'setDnsVerifiedAt',
    ...
    protected static $getters = [
        'id' => 'getId',
        'domain' => 'getDomain',
        'reporting_address' => 'getReportingAddress',
        'dns_verified' => 'getDnsVerified',
        'dns_verified_at' => 'getDnsVerifiedAt',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('reporting_address', $data ?? [], null);
        $this->setIfExists('dns_verified', $data ?? [], null);
        $this->setIfExists('dns_verified_at', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets reporting_address
     *
     * @return string|null
     */
    public function getReportingAddress()
    {
        return $this->container['reporting_address'];
    }

    /**
     * Sets reporting_address
     *
     * @param string|null $reporting_address DMARC aggregate report receiving address
     *
     * @return self
     */
    public function setReportingAddress($reporting_address)
    {
        if (is_null($reporting_address)) {
            throw new \InvalidArgumentException('non-nullable reporting_address cannot be null');
        }
        $this->container['reporting_address'] = $reporting_address;
     ...
     * @return bool|null
     */
    public function getDnsVerified()
    {
        return $this->container['dns_verified'];
    }

    /**
     * Sets dns_verified
     *
     * @param bool|null $dns_verified Whether DNS record has been verified
     *
     * @return self
     */
    public function setDnsVerified($dns_verified)
    {
        if (is_null($dns_verified)) {
            throw new \InvalidArgumentException('non-nullable dns_verified cannot be null');
        }
        $this->container['dns_verified'] = $dns_verified;

        return $this;
    }

    /**
     * Gets dns_verified_at
     *
     * @return \DateTime|null
     */
    public function getDnsVerifiedAt()
    {
        return $this->container['dns_verified_at'];
    }

    /**
     * Sets dns_verified_at
     *
     * @param \DateTime|null $dns_verified_at dns_verified_at
     *
     * @return self
     */
    public function setDnsVerifiedAt($dns_verified_at)
    {
        if (is_null($dns_verified_at)) {
            array_push($this->openAPINullablesSetToNull, 'dns_verified_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dns_verified_at', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['dns_verified_at'] = $dns_verified_at;
     ...
     * Gets summary
     *
     * @return \MailOdds\Model\GetDmarcDomain200ResponseDomainAllOfSummary|null
     */
     ...
     * Sets summary
     *
     * @param \MailOdds\Model\GetDmarcDomain200ResponseDomainAllOfSummary|null $summary summary
     *
     * @return self
     */
