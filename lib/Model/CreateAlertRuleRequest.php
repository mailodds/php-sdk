...
class CreateAlertRuleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createAlertRule_request';
    ...
    */
     ...
     * Sets metric
     *
     * @param string $metric Metric to monitor (e.g., bounce_rate, complaint_rate)
     *
     * @return self
     */
     ...
     * Sets channel
     *
     * @param string $channel Notification channel (e.g., webhook)
     *
     * @return self
     */
