...
class SyncResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'existing_job_id' => 'setExistingJobId'
    ];
    ...
    protected static $getters = [
        ...
        'existing_job_id' => 'getExistingJobId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('existing_job_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets idempotent
     *
     * @param bool|null $idempotent True if this was a duplicate request matched by Idempotency-Key
     *
     * @return self
     */
    ...
    /**
     * Gets existing_job_id
     *
     * @return string|null
     */
    public function getExistingJobId()
    {
        return $this->container['existing_job_id'];
    }

    /**
     * Sets existing_job_id
     *
     * @param string|null $existing_job_id ID of existing sync job if one was already running
     *
     * @return self
     */
    public function setExistingJobId($existing_job_id)
    {
        if (is_null($existing_job_id)) {
            throw new \InvalidArgumentException('non-nullable existing_job_id cannot be null');
        }
        $this->container['existing_job_id'] = $existing_job_id;
