...
/**
 * RunBlacklistCheck200ResponseCheck Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class RunBlacklistCheck200ResponseCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'runBlacklistCheck_200_response_check';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('listed_on', $data ?? [], null);
        $this->setIfExists('clean_on', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['listed_on'];
    }

    /**
     * Sets listed_on
     *
     * @param string[]|null $listed_on Blacklists where the target is listed
     *
     * @return self
     */
    public function setListedOn($listed_on)
    {
        if (is_null($listed_on)) {
            throw new \InvalidArgumentException('non-nullable listed_on cannot be null');
        }
        $this->container['listed_on'] = $listed_on;
     ...
     * @return string[]|null
     */
    public function getCleanOn()
    {
        return $this->container['clean_on'];
    }

    /**
     * Sets clean_on
     *
     * @param string[]|null $clean_on Blacklists where the target is clean
     *
     * @return self
     */
    public function setCleanOn($clean_on)
    {
        if (is_null($clean_on)) {
            throw new \InvalidArgumentException('non-nullable clean_on cannot be null');
        }
        $this->container['clean_on'] = $clean_on;
