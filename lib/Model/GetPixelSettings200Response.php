...
/**
 * GetPixelSettings200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class GetPixelSettings200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPixelSettings_200_response';
    ...
    protected static $attributeMap = [
        ...
        'pixel_subscribe_list_id' => 'pixel_subscribe_list_id'
    ];
    ...
    protected static $setters = [
        'pixel_uuid' => 'setPixelUuid',
        'pixel_subscribe_list_id' => 'setPixelSubscribeListId'
    ];
    ...
    protected static $getters = [
        'pixel_uuid' => 'getPixelUuid',
        'pixel_subscribe_list_id' => 'getPixelSubscribeListId'
    ];
    ...
    {
        $this->setIfExists('pixel_uuid', $data ?? [], null);
        $this->setIfExists('pixel_subscribe_list_id', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getPixelUuid()
    {
        return $this->container['pixel_uuid'];
    }

    /**
     * Sets pixel_uuid
     *
     * @param string|null $pixel_uuid pixel_uuid
     *
     * @return self
     */
    public function setPixelUuid($pixel_uuid)
    {
        if (is_null($pixel_uuid)) {
            array_push($this->openAPINullablesSetToNull, 'pixel_uuid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pixel_uuid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['pixel_uuid'] = $pixel_uuid;

        return $this;
    }

    /**
     * Gets pixel_subscribe_list_id
     *
     * @return int|null
     */
    public function getPixelSubscribeListId()
    {
        return $this->container['pixel_subscribe_list_id'];
    }

    /**
     * Sets pixel_subscribe_list_id
     *
     * @param int|null $pixel_subscribe_list_id pixel_subscribe_list_id
     *
     * @return self
     */
    public function setPixelSubscribeListId($pixel_subscribe_list_id)
    {
        if (is_null($pixel_subscribe_list_id)) {
            array_push($this->openAPINullablesSetToNull, 'pixel_subscribe_list_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pixel_subscribe_list_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['pixel_subscribe_list_id'] = $pixel_subscribe_list_id;
