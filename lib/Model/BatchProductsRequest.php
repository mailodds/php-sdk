...
/**
 * BatchProductsRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class BatchProductsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchProductsRequest';
    ...
    protected static $openAPITypes = [
        'products' => '\MailOdds\Model\BatchProductsRequestProductsInner[]'
    ];
    ...
    */
     ...
     * Gets products
     *
     * @return \MailOdds\Model\BatchProductsRequestProductsInner[]
     */
     ...
     * Sets products
     *
     * @param \MailOdds\Model\BatchProductsRequestProductsInner[] $products products
     *
     * @return self
     */
    public function setProducts($products)
    {
        ...
        if ((count($products) > 100)) {
            throw new \InvalidArgumentException('invalid value for $products when calling BatchProductsRequest., number of items must be less than or equal to 100.');
        }
