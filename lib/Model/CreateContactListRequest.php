...
class CreateContactListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('source_job_id', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['source_job_id'];
    }

    /**
     * Sets source_job_id
     *
     * @param string|null $source_job_id Single validation job ID to build list from
     *
     * @return self
     */
    public function setSourceJobId($source_job_id)
    {
        if (is_null($source_job_id)) {
            throw new \InvalidArgumentException('non-nullable source_job_id cannot be null');
        }
        $this->container['source_job_id'] = $source_job_id;
     ...
     * Sets source_job_ids
     *
     * @param string[]|null $source_job_ids Multiple validation job IDs to merge into one list
     *
     * @return self
     */
