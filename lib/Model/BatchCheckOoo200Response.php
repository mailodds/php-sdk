...
/**
 * BatchCheckOoo200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class BatchCheckOoo200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'batchCheckOoo_200_response';
    ...
    protected static $openAPITypes = [
        'results' => '\MailOdds\Model\BatchCheckOoo200ResponseResultsInner[]',
        'total' => 'int',
        'ooo_count' => 'int'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ooo_count', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets results
     *
     * @return \MailOdds\Model\BatchCheckOoo200ResponseResultsInner[]|null
     */
     ...
     * Sets results
     *
     * @param \MailOdds\Model\BatchCheckOoo200ResponseResultsInner[]|null $results results
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getOooCount()
    {
        return $this->container['ooo_count'];
    }

    /**
     * Sets ooo_count
     *
     * @param int|null $ooo_count ooo_count
     *
     * @return self
     */
    public function setOooCount($ooo_count)
    {
        if (is_null($ooo_count)) {
            throw new \InvalidArgumentException('non-nullable ooo_count cannot be null');
        }
        $this->container['ooo_count'] = $ooo_count;
