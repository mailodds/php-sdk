...
/**
 * ListSpamChecks200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class ListSpamChecks200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listSpamChecks_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'request_id' => 'string',
        'spam_checks' => '\MailOdds\Model\SpamCheck[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('spam_checks', $data ?? [], null);
    ...
    */
     ...
     * Gets spam_checks
     *
     * @return \MailOdds\Model\SpamCheck[]|null
     */
    public function getSpamChecks()
    {
        return $this->container['spam_checks'];
    }

    /**
     * Sets spam_checks
     *
     * @param \MailOdds\Model\SpamCheck[]|null $spam_checks spam_checks
     *
     * @return self
     */
    public function setSpamChecks($spam_checks)
    {
        if (is_null($spam_checks)) {
            throw new \InvalidArgumentException('non-nullable spam_checks cannot be null');
        }
        $this->container['spam_checks'] = $spam_checks;
