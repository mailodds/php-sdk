...
/**
 * GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCampaignDeliveryConfidence_200_response_factors_sender_reputation';
    ...
    protected static $openAPIFormats = [
        'score' => null,
        'recent_bounce_rate' => null,
        'recent_complaint_rate' => null
    ];
    ...
    protected static array $openAPINullables = [
        'score' => false,
        'recent_bounce_rate' => false,
        'recent_complaint_rate' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'recent_complaint_rate' => 'recent_complaint_rate'
    ];
    ...
    protected static $setters = [
        'score' => 'setScore',
        'recent_bounce_rate' => 'setRecentBounceRate',
        'recent_complaint_rate' => 'setRecentComplaintRate'
    ];
    ...
    protected static $getters = [
        'score' => 'getScore',
        'recent_bounce_rate' => 'getRecentBounceRate',
        'recent_complaint_rate' => 'getRecentComplaintRate'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('recent_bounce_rate', $data ?? [], null);
        $this->setIfExists('recent_complaint_rate', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets recent_bounce_rate
     *
     * @return float|null
     */
    public function getRecentBounceRate()
    {
        return $this->container['recent_bounce_rate'];
    }

    /**
     * Sets recent_bounce_rate
     *
     * @param float|null $recent_bounce_rate recent_bounce_rate
     *
     * @return self
     */
    public function setRecentBounceRate($recent_bounce_rate)
    {
        if (is_null($recent_bounce_rate)) {
            throw new \InvalidArgumentException('non-nullable recent_bounce_rate cannot be null');
        }
        $this->container['recent_bounce_rate'] = $recent_bounce_rate;

        return $this;
    }

    /**
     * Gets recent_complaint_rate
     *
     * @return float|null
     */
    public function getRecentComplaintRate()
    {
        return $this->container['recent_complaint_rate'];
    }

    /**
     * Sets recent_complaint_rate
     *
     * @param float|null $recent_complaint_rate recent_complaint_rate
     *
     * @return self
     */
    public function setRecentComplaintRate($recent_complaint_rate)
    {
        if (is_null($recent_complaint_rate)) {
            throw new \InvalidArgumentException('non-nullable recent_complaint_rate cannot be null');
        }
        $this->container['recent_complaint_rate'] = $recent_complaint_rate;
