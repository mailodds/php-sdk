...
/**
 * AppendToContactListRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class AppendToContactListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'appendToContactList_request';
    ...
    protected static $setters = [
        ...
        'include_catch_all' => 'setIncludeCatchAll'
    ];
    ...
    protected static $getters = [
        ...
        'include_catch_all' => 'getIncludeCatchAll'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('include_catch_all', $data ?? [], false);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['source_job_ids'] === null) {
            $invalidProperties[] = "'source_job_ids' can't be null";
        }
     ...
     * Sets source_job_ids
     *
     * @param string[] $source_job_ids Validation job IDs to append from
     *
     * @return self
     */
    ...
    /**
     * Gets include_catch_all
     *
     * @return bool|null
     */
    public function getIncludeCatchAll()
    {
        return $this->container['include_catch_all'];
    }

    /**
     * Sets include_catch_all
     *
     * @param bool|null $include_catch_all Include catch-all emails in addition to valid ones
     *
     * @return self
     */
    public function setIncludeCatchAll($include_catch_all)
    {
        if (is_null($include_catch_all)) {
            throw new \InvalidArgumentException('non-nullable include_catch_all cannot be null');
        }
        $this->container['include_catch_all'] = $include_catch_all;
