...
/**
 * BulkUpdateProductsRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class BulkUpdateProductsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bulkUpdateProducts_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['product_ids']) > 500)) {
            $invalidProperties[] = "invalid value for 'product_ids', number of items must be less than or equal to 500.";
        }
     ...
     * Sets product_ids
     *
     * @param string[] $product_ids Product IDs to update
     *
     * @return self
     */
    public function setProductIds($product_ids)
    {
        ...
        if ((count($product_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $product_ids when calling BulkUpdateProductsRequest., number of items must be less than or equal to 500.');
        }
     ...
     * Sets is_active
     *
     * @param bool $is_active Set product visibility
     *
     * @return self
     */
