...
/**
 * ListSyncJobs200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class ListSyncJobs200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listSyncJobs_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sync_jobs', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['sync_jobs'];
    }

    /**
     * Sets sync_jobs
     *
     * @param object[]|null $sync_jobs sync_jobs
     *
     * @return self
     */
    public function setSyncJobs($sync_jobs)
    {
        if (is_null($sync_jobs)) {
            throw new \InvalidArgumentException('non-nullable sync_jobs cannot be null');
        }
        $this->container['sync_jobs'] = $sync_jobs;
