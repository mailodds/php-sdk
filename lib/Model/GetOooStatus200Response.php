...
/**
 * GetOooStatus200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class GetOooStatus200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getOooStatus_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_ooo', $data ?? [], null);
        $this->setIfExists('detected_at', $data ?? [], null);
        $this->setIfExists('expires_at', $data ?? [], null);
        $this->setIfExists('ooo_type', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getIsOoo()
    {
        return $this->container['is_ooo'];
    }

    /**
     * Sets is_ooo
     *
     * @param bool|null $is_ooo is_ooo
     *
     * @return self
     */
    public function setIsOoo($is_ooo)
    {
        if (is_null($is_ooo)) {
            throw new \InvalidArgumentException('non-nullable is_ooo cannot be null');
        }
        $this->container['is_ooo'] = $is_ooo;
    ...
    {
        if (is_null($ooo_type)) {
            array_push($this->openAPINullablesSetToNull, 'ooo_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ooo_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
