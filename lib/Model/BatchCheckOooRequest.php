...
/**
 * BatchCheckOooRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class BatchCheckOooRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'batchCheckOoo_request';
    ...
    */
    ...
    public function setEmails($emails)
    {
        ...
        if ((count($emails) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $emails when calling BatchCheckOooRequest., number of items must be less than or equal to 1000.');
        }
