...
/**
 * TrackEventResponse Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class TrackEventResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackEventResponse';
    ...
    */
     ...
     * Sets created
     *
     * @param bool|null $created True if newly created, false if idempotent duplicate
     *
     * @return self
     */
     ...
     * Sets idempotent
     *
     * @param bool|null $idempotent Present and true when returning an existing event
     *
     * @return self
     */
