...
/**
 * ValidationResultSuppression Class Doc Comment
 *
 * @category Class
 * @description Present only when email matched a suppression entry.
 * @package  MailOdds
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ValidationResultSuppression implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValidationResult_suppression';
