...
class SubscribeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscribeRequest';
    ...
    */
     ...
     * Sets metadata
     *
     * @param object|null $metadata Custom metadata key-value pairs
     *
     * @return self
     */
     ...
     * Sets page_url
     *
     * @param string|null $page_url URL of the page where the subscription form was submitted (for consent proof)
     *
     * @return self
     */
     ...
     * Sets form_id
     *
     * @param string|null $form_id Identifier of the form used to subscribe (for consent proof)
     *
     * @return self
     */
