...
/**
 * ClassifyContent200Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class ClassifyContent200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'classifyContent_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'request_id' => 'string',
        'content_check' => '\MailOdds\Model\ClassifyContent200ResponseContentCheck'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('content_check', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets content_check
     *
     * @return \MailOdds\Model\ClassifyContent200ResponseContentCheck|null
     */
    public function getContentCheck()
    {
        return $this->container['content_check'];
    }

    /**
     * Sets content_check
     *
     * @param \MailOdds\Model\ClassifyContent200ResponseContentCheck|null $content_check content_check
     *
     * @return self
     */
    public function setContentCheck($content_check)
    {
        if (is_null($content_check)) {
            throw new \InvalidArgumentException('non-nullable content_check cannot be null');
        }
        $this->container['content_check'] = $content_check;
