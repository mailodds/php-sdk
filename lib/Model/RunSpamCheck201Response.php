...
/**
 * RunSpamCheck201Response Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class RunSpamCheck201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'runSpamCheck_201_response';
    ...
    protected static $openAPITypes = [
        ...
        'request_id' => 'string',
        'spam_check' => '\MailOdds\Model\SpamCheck'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('spam_check', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['spam_check'];
    }

    /**
     * Sets spam_check
     *
     * @param \MailOdds\Model\SpamCheck|null $spam_check spam_check
     *
     * @return self
     */
    public function setSpamCheck($spam_check)
    {
        if (is_null($spam_check)) {
            throw new \InvalidArgumentException('non-nullable spam_check cannot be null');
        }
        $this->container['spam_check'] = $spam_check;
