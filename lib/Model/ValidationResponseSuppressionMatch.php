 ...
 */
class ValidationResponseSuppressionMatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValidationResponse_suppression_match';
