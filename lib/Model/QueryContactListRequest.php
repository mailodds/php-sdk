...
/**
 * QueryContactListRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class QueryContactListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'queryContactList_request';
    ...
    protected static $openAPITypes = [
        'filters' => '\MailOdds\Model\QueryContactListRequestFiltersInner[]',
        'page' => 'int',
        'per_page' => 'int'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('per_page', $data ?? [], 100);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['per_page']) && ($this->container['per_page'] > 500)) {
     ...
     * Gets filters
     *
     * @return \MailOdds\Model\QueryContactListRequestFiltersInner[]|null
     */
     ...
     * Sets filters
     *
     * @param \MailOdds\Model\QueryContactListRequestFiltersInner[]|null $filters Array of filter conditions
     *
     * @return self
     */
    ...
    public function setPerPage($per_page)
    {
        ...
        if (($per_page > 500)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling QueryContactListRequest., must be smaller than or equal to 500.');
        }
