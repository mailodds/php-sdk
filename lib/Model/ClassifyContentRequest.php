...
/**
 * ClassifyContentRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class ClassifyContentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'classifyContent_request';
    ...
    */
     ...
     * Sets html_body
     *
     * @param string|null $html_body HTML email body
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param string|null $content Raw text content (alternative to subject+html_body)
     *
     * @return self
     */
