...
/**
 * UpdateOooContactRequest Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class UpdateOooContactRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateOooContact_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ooo_type', $data ?? [], 'out_of_office');
        $this->setIfExists('duration_days', $data ?? [], 7);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['duration_days']) && ($this->container['duration_days'] > 365)) {
            $invalidProperties[] = "invalid value for 'duration_days', must be smaller than or equal to 365.";
        }

        if (!is_null($this->container['duration_days']) && ($this->container['duration_days'] < 1)) {
            $invalidProperties[] = "invalid value for 'duration_days', must be bigger than or equal to 1.";
        }
     ...
     * Sets is_active
     *
     * @param bool|null $is_active Set to false to clear OOO status
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getOooType()
    {
        return $this->container['ooo_type'];
    }

    /**
     * Sets ooo_type
     *
     * @param string|null $ooo_type ooo_type
     *
     * @return self
     */
    public function setOooType($ooo_type)
    {
        if (is_null($ooo_type)) {
            throw new \InvalidArgumentException('non-nullable ooo_type cannot be null');
        }
        $this->container['ooo_type'] = $ooo_type;
     ...
     * Sets duration_days
     *
     * @param int|null $duration_days duration_days
     *
     * @return self
     */
    public function setDurationDays($duration_days)
    {
        ...
        if (($duration_days > 365)) {
            throw new \InvalidArgumentException('invalid value for $duration_days when calling UpdateOooContactRequest., must be smaller than or equal to 365.');
        }
        if (($duration_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $duration_days when calling UpdateOooContactRequest., must be bigger than or equal to 1.');
        }
