...
/**
 * JobArtifacts Class Doc Comment
 *
 * @category Class
 * @description Download URLs for completed jobs. Present only when status is completed.
 * @package  MailOdds
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class JobArtifacts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Job_artifacts';
    ...
    protected static $setters = [
        'csv_all' => 'setCsvAll',
        'csv_valid' => 'setCsvValid',
        'csv_invalid' => 'setCsvInvalid'
    ];
    ...
    protected static $getters = [
        'csv_all' => 'getCsvAll',
        'csv_valid' => 'getCsvValid',
        'csv_invalid' => 'getCsvInvalid'
    ];
    ...
    {
        $this->setIfExists('csv_all', $data ?? [], null);
        $this->setIfExists('csv_valid', $data ?? [], null);
        $this->setIfExists('csv_invalid', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['csv_all'];
    }

    /**
     * Sets csv_all
     *
     * @param string|null $csv_all CSV with all results
     *
     * @return self
     */
    public function setCsvAll($csv_all)
    {
        if (is_null($csv_all)) {
            throw new \InvalidArgumentException('non-nullable csv_all cannot be null');
        }
        $this->container['csv_all'] = $csv_all;
     ...
     * @return string|null
     */
    public function getCsvValid()
    {
        return $this->container['csv_valid'];
    }

    /**
     * Sets csv_valid
     *
     * @param string|null $csv_valid CSV with valid emails only
     *
     * @return self
     */
    public function setCsvValid($csv_valid)
    {
        if (is_null($csv_valid)) {
            throw new \InvalidArgumentException('non-nullable csv_valid cannot be null');
        }
        $this->container['csv_valid'] = $csv_valid;
     ...
     * @return string|null
     */
    public function getCsvInvalid()
    {
        return $this->container['csv_invalid'];
    }

    /**
     * Sets csv_invalid
     *
     * @param string|null $csv_invalid CSV with invalid emails only
     *
     * @return self
     */
    public function setCsvInvalid($csv_invalid)
    {
        if (is_null($csv_invalid)) {
            throw new \InvalidArgumentException('non-nullable csv_invalid cannot be null');
        }
        $this->container['csv_invalid'] = $csv_invalid;
