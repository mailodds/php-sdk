...
/**
 * GetCampaignDeliveryConfidence200ResponseFactorsListQuality Class Doc Comment
 *
 * @category Class
 * @package  MailOdds
 * @author   OpenAPI Generator team
 ...
 */
class GetCampaignDeliveryConfidence200ResponseFactorsListQuality implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCampaignDeliveryConfidence_200_response_factors_list_quality';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('validated_pct', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $total_recipients total_recipients
     *
     * @return self
     */
     ...
     * @return float|null
     */
    public function getValidatedPct()
    {
        return $this->container['validated_pct'];
    }

    /**
     * Sets validated_pct
     *
     * @param float|null $validated_pct validated_pct
     *
     * @return self
     */
    public function setValidatedPct($validated_pct)
    {
        if (is_null($validated_pct)) {
            throw new \InvalidArgumentException('non-nullable validated_pct cannot be null');
        }
        $this->container['validated_pct'] = $validated_pct;
     ...
     *
     * @param int|null $suppressed_count suppressed_count
     *
     * @return self
     */
