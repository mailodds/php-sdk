 ...
 */
class SpamCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpamCheck';
    ...
    protected static $openAPITypes = [
        ...
        'score' => 'float',
        'verdict' => 'string',
        'checks' => '\MailOdds\Model\SpamCheckChecks',
        'created_at' => '\DateTime'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Spam check UUID
     *
     * @return self
     */
     ...
     * Sets score
     *
     * @param float|null $score Overall spam score (0-10, lower is better)
     *
     * @return self
     */
     ...
     * Gets checks
     *
     * @return \MailOdds\Model\SpamCheckChecks|null
     */
     ...
     * Sets checks
     *
     * @param \MailOdds\Model\SpamCheckChecks|null $checks checks
     *
     * @return self
     */
